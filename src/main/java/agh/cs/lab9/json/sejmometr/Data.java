...
public class Data {
    ...
    private Integer poslowieWartoscBiuroPodrozePracownikow;
    ...
    @JsonProperty("poslowie.wartosc_biuro_podroze_pracownikow")
    public Integer getPoslowieWartoscBiuroPodrozePracownikow() {
        return poslowieWartoscBiuroPodrozePracownikow;
    }

    @JsonProperty("poslowie.wartosc_biuro_podroze_pracownikow")
    public void setPoslowieWartoscBiuroPodrozePracownikow(Integer poslowieWartoscBiuroPodrozePracownikow) {
