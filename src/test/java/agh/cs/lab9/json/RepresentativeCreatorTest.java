...
public class RepresentativeCreatorTest {
    ...
    public void getSpendingsUrl() throws Exception {
        RepresentativeCreator representativeDataGetter = new RepresentativeCreator(RepresentativeUpdater.url, 174);
    ...
    public void getTripsUrl() throws Exception {
        RepresentativeCreator representativeDataGetter = new RepresentativeCreator(RepresentativeUpdater.url, 261);
